...
public class ModeloConsultaImpl extends MinimalEObjectImpl.Container implements ModeloConsulta {
	...
	/**
	 * Metodo que permite crear una nueva 
	 * lista de EADiagrams
	 */
	public EList<EADiagram> createtListEADiagram() {
		return new EObjectContainmentWithInverseEList<EADiagram>(EADiagram.class, 
				this, ModeloconsultasPackage.MODELO_CONSULTA__LIST_EA_DIAGRAM, 
				ModelPackage.EA_DIAGRAM__MODELO_CONSULTA);
	}
	
	/**
	 * Metodo que sirve para settear el EADiagram
	 * de la modelFactory
	 * @param listEADiagram
	 */
	public void setEADiagram(EList<EADiagram> listEADiagram){
		this.listEADiagram = listEADiagram;
	}
