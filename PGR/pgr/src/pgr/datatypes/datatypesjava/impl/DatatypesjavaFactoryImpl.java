...
import pgr.datatypes.datatypesjava.*;
 ...
 * @generated
 */
public class DatatypesjavaFactoryImpl extends EFactoryImpl implements DatatypesjavaFactory {
	/**
	 ...
	 * @generated
	 */
	public static DatatypesjavaFactory init() {
		try {
			DatatypesjavaFactory theDatatypesjavaFactory = (DatatypesjavaFactory)EPackage.Registry.INSTANCE.getEFactory(DatatypesjavaPackage.eNS_URI);
			if (theDatatypesjavaFactory != null) {
				return theDatatypesjavaFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new DatatypesjavaFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public DatatypesjavaFactoryImpl() {
		super();
	}
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case DatatypesjavaPackage.OBJECT:
				return createObjectFromString(eDataType, initialValue);
			case DatatypesjavaPackage.INPUT_STREAM:
				return createInputStreamFromString(eDataType, initialValue);
			case DatatypesjavaPackage.OUTPUT_STREAM:
	 ...
	 * @generated
	 */
	public DatatypesjavaPackage getDatatypesjavaPackage() {
		return (DatatypesjavaPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static DatatypesjavaPackage getPackage() {
		return DatatypesjavaPackage.eINSTANCE;
	}

} //DatatypesjavaFactoryImpl
