...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Excel
 * Generator</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getAbsolutePath
 * <em>Absolute Path</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getWorkbook
 * <em>Workbook</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getNewDataSheet
 * <em>New Data Sheet</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getDataSheet
 * <em>Data Sheet</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getColumnSheet
 * <em>Column Sheet</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getSheet
 * <em>Sheet</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getQueryString
 * <em>Query String</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getModelFactoryQM
 * <em>Model Factory QM</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getResultSet
 * <em>Result Set</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getNamesFilters
 * <em>Names Filters</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getPosFilters
 * <em>Pos Filters</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getTitlesMap
 * <em>Titles Map</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getSetResult <em>Set
 * Result</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getListFixed
 * <em>List Fixed</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getResult
 * <em>Result</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getTuplesList
 * <em>Tuples List</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getColumns
 * <em>Columns</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getColumnsNames
 * <em>Columns Names</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getColumnsIndex
 * <em>Columns Index</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getAcc
 * <em>Acc</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getFirstRowFilter
 * <em>First Row Filter</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getPosRowIniData
 * <em>Pos Row Ini Data</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getPosCellIniData
 * <em>Pos Cell Ini Data</em>}</li>
 * <li>{@link pgr.domain.generators.impl.ExcelGeneratorImpl#getTheDomain <em>The
 * Domain</em>}</li>
 * </ul>
 *
 * @generated
...
public class ExcelGeneratorImpl extends MinimalEObjectImpl.Container implements ExcelGenerator {
	/**
	 * The default value of the '{@link #getAbsolutePath() <em>Absolute
	...
	/**
	 * The cached value of the '{@link #getAbsolutePath() <em>Absolute
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getAbsolutePath()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getWorkbook() <em>Workbook</em>}'
	...
	/**
	 * The cached value of the '{@link #getWorkbook() <em>Workbook</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getWorkbook()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getNewDataSheet() <em>New Data
	 * Sheet</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getNewDataSheet()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getNewDataSheet() <em>New Data
	 * Sheet</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getNewDataSheet()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getDataSheet() <em>Data Sheet</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getDataSheet()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getDataSheet() <em>Data Sheet</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getDataSheet()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getColumnSheet() <em>Column
	 * Sheet</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getColumnSheet()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getColumnSheet() <em>Column Sheet</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getColumnSheet()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getQueryString() <em>Query
	...
	/**
	 * The cached value of the '{@link #getQueryString() <em>Query String</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getQueryString()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getModelFactoryQM() <em>Model Factory
	 * QM</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * The cached value of the '{@link #getModelFactoryQM() <em>Model Factory
	 * QM</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getModelFactoryQM()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getResultSet() <em>Result Set</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getResultSet()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getNamesFilters() <em>Names
	 * Filters</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getNamesFilters()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getNamesFilters() <em>Names
	 * Filters</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getNamesFilters()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPosFilters() <em>Pos Filters</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getPosFilters()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPosFilters() <em>Pos Filters</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getPosFilters()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getTitlesMap() <em>Titles Map</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getTitlesMap()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getTitlesMap() <em>Titles Map</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getTitlesMap()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getSetResult() <em>Set Result</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getSetResult()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getSetResult() <em>Set Result</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getSetResult()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getListFixed() <em>List Fixed</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getListFixed()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getListFixed() <em>List Fixed</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getListFixed()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getTuplesList() <em>Tuples List</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getTuplesList()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getTuplesList() <em>Tuples List</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getTuplesList()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getColumnsNames() <em>Columns
	 * Names</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getColumnsNames()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getColumnsNames() <em>Columns
	 * Names</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getColumnsNames()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getColumnsIndex() <em>Columns
	...
	/**
	 * The cached value of the '{@link #getColumnsIndex() <em>Columns
	 * Index</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getColumnsIndex()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getFirstRowFilter() <em>First Row
	...
	/**
	 * The cached value of the '{@link #getFirstRowFilter() <em>First Row
	 * Filter</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getFirstRowFilter()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPosRowIniData() <em>Pos Row Ini
	...
	/**
	 * The cached value of the '{@link #getPosRowIniData() <em>Pos Row Ini
	 * Data</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getPosRowIniData()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPosCellIniData() <em>Pos Cell Ini
	 * Data</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * The cached value of the '{@link #getPosCellIniData() <em>Pos Cell Ini
	 * Data</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getPosCellIniData()
	 * @generated
	...
	public void setAbsolutePath(String newAbsolutePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__ABSOLUTE_PATH,
	...
	public void setWorkbook(XSSFWorkbook newWorkbook) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__WORKBOOK,
	...
	public void setNewDataSheet(XSSFSheet newNewDataSheet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__NEW_DATA_SHEET,
					oldNewDataSheet, newDataSheet));
	}
	...
	public void setDataSheet(XSSFSheet newDataSheet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__DATA_SHEET,
					oldDataSheet, dataSheet));
	}
	...
	public void setColumnSheet(XSSFSheet newColumnSheet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__COLUMN_SHEET,
					oldColumnSheet, columnSheet));
	}
	...
	public void setSheet(XSSFSheet newSheet) {
		...
		sheet = newSheet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__SHEET, oldSheet,
					sheet));
	}
	...
	public void setQueryString(String newQueryString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__QUERY_STRING,
	...
	public void setModelFactoryQM(ModelFactory newModelFactoryQM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__MODEL_FACTORY_QM,
					oldModelFactoryQM, modelFactoryQM));
	}
	...
	public void setResultSet(ArrayList newResultSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__RESULT_SET,
	...
	public void setNamesFilters(ArrayList newNamesFilters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__NAMES_FILTERS,
					oldNamesFilters, namesFilters));
	}
	...
	public void setPosFilters(ArrayList newPosFilters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__POS_FILTERS,
					oldPosFilters, posFilters));
	}
	...
	public void setTitlesMap(HashMap newTitlesMap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__TITLES_MAP,
					oldTitlesMap, titlesMap));
	}
	...
	public void setSetResult(ArrayList newSetResult) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__SET_RESULT,
					oldSetResult, setResult));
	}
	...
	public void setListFixed(ArrayList newListFixed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__LIST_FIXED,
					oldListFixed, listFixed));
	}
	...
	public void setResult(Resultado newResult) {
		...
		result = newResult;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__RESULT, oldResult,
					result));
	}
	...
	public void setTuplesList(ArrayList newTuplesList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__TUPLES_LIST,
					oldTuplesList, tuplesList));
	}
	...
	public void setColumns(ArrayList newColumns) {
		...
		columns = newColumns;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__COLUMNS,
					oldColumns, columns));
	}
	...
	public void setColumnsNames(ArrayList newColumnsNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__COLUMNS_NAMES,
					oldColumnsNames, columnsNames));
	}
	...
	public void setColumnsIndex(ArrayList newColumnsIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__COLUMNS_INDEX,
					oldColumnsIndex, columnsIndex));
	}
	...
	public void setFirstRowFilter(int newFirstRowFilter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__FIRST_ROW_FILTER,
					oldFirstRowFilter, firstRowFilter));
	}
	...
	public void setPosRowIniData(int newPosRowIniData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__POS_ROW_INI_DATA,
					oldPosRowIniData, posRowIniData));
	}
	...
	public void setPosCellIniData(int newPosCellIniData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__POS_CELL_INI_DATA,
					oldPosCellIniData, posCellIniData));
	}
	...
	public Domain getTheDomain() {
		if (eContainerFeatureID() != GeneratorsPackage.EXCEL_GENERATOR__THE_DOMAIN)
			return null;
	...
	public void setTheDomain(Domain newTheDomain) {
		if (newTheDomain != eInternalContainer()
				|| (eContainerFeatureID() != GeneratorsPackage.EXCEL_GENERATOR__THE_DOMAIN && newTheDomain != null)) {
			...
			if (newTheDomain != null)
				msgs = ((InternalEObject) newTheDomain).eInverseAdd(this, DomainPackage.DOMAIN__THE_EXCEL_GENERATOR,
						Domain.class, msgs);
			msgs = basicSetTheDomain(newTheDomain, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorsPackage.EXCEL_GENERATOR__THE_DOMAIN,
					newTheDomain, newTheDomain));
	}
	...
	public void ExcelGenerator(final String absolutePath, final ArrayList listFilter, final ArrayList posFilters,
			final ModelFactory modelFactoryQM, final int posRowIniData, final int posCellIniData,
	...
	public void initDataSheet(final ArrayList indexColum) {
		...
		for (int i = 0; i < result.getListResultElement().size(); i++) {
			element = (gestionmodelosconsultas.modeloconsultas.resultset.ElementoModeloResultado) result
					.getListResultElement().get(i);
	...
	public void createTable(final ArrayList columns, final int size, final XSSFSheet sheet) {
		...
		org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTableStyleInfo table_style = cttable
		...
		org.apache.poi.hssf.util.AreaReference my_data_range = new org.apache.poi.hssf.util.AreaReference(
				new org.apache.poi.hssf.util.CellReference(0, 0),
				new org.apache.poi.hssf.util.CellReference(size, columns.size() - 1));

		/* Set Range to the Table */
		cttable.setRef(my_data_range.formatAsString());
		cttable.setDisplayName(sheet
				.getSheetName()); /* this is the display name of the table */
		cttable.setName(sheet.getSheetName()); /*
												 * This maps to "displayName"
												 * attribute in <table>, OOXML
												 */
		cttable.setId((long) (workbook.getSheetIndex(sheet) + 1)); // id
																	// attribute
																	// against
																	// table as
																	// long
	...
	public void exploreResult(final EList elementResultList, final String tuple) {
		...
		for (int i = 0; i < elementResultList.size(); i++) {
			element = (gestionmodelosconsultas.modeloconsultas.resultset.ElementoModeloResultado) elementResultList
					.get(i);
			String s = getAtributtes(element);
	 ...
	 * @generated
	 */
	public void execute(final ArrayList listFilter, final HashMap titlesMap, final int acc, final int posRowIniData,
			final int posCellIniData) {
		...
		theFormula(posRowIniData + 1, posCellIniData, acc + 1, 0,
				(int) titlesMap.get(listFilter.get(listFilter.size() - 1)),
				((ArrayList<String>) resultSet.get(0)).size(), resultSet.size());
		...
		for (int i = 1; i < posFilters.size(); i++) {
			...
			validation = helper.createValidation(constraint,
					new org.apache.poi.ss.util.CellRangeAddressList(
							...
							((pgr.domain.util.impl.CoordinateImpl) posFilters.get(i)).getX(),
							((pgr.domain.util.impl.CoordinateImpl) posFilters.get(i)).getY(),
							((pgr.domain.util.impl.CoordinateImpl) posFilters.get(i)).getY()));
			sheet.addValidationData(validation);
		}
	}
	...
	public void countFormula(final int targetRow, final int targetCell) {
		...
		String formula = "COUNTIFS(ResultSet[" + namesFilters.get(0) + "]," + sheet.getSheetName() + "!"
				+ getNumToCol(((pgr.domain.util.impl.CoordinateImpl) posFilters.get(0)).getY())
				+ (((pgr.domain.util.impl.CoordinateImpl) posFilters.get(0)).getX() + 1);
		for (int i = 1; i < namesFilters.size(); i++) {
			formula += ",ResultSet[" + namesFilters.get(i) + "]," + sheet.getSheetName() + "!"
					+ getNumToCol(((pgr.domain.util.impl.CoordinateImpl) posFilters.get(i)).getY())
					+ (((pgr.domain.util.impl.CoordinateImpl) posFilters.get(i)).getX() + 1);
		}
		formula += ")";
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case GeneratorsPackage.EXCEL_GENERATOR__THE_DOMAIN:
			return eInternalContainer().eInverseRemove(this, DomainPackage.DOMAIN__THE_EXCEL_GENERATOR, Domain.class,
					msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case GeneratorsPackage.EXCEL_GENERATOR__NEW_DATA_SHEET:
			return NEW_DATA_SHEET_EDEFAULT == null ? newDataSheet != null
					: !NEW_DATA_SHEET_EDEFAULT.equals(newDataSheet);
		case GeneratorsPackage.EXCEL_GENERATOR__DATA_SHEET:
		...
		case GeneratorsPackage.EXCEL_GENERATOR__MODEL_FACTORY_QM:
			return MODEL_FACTORY_QM_EDEFAULT == null ? modelFactoryQM != null
					: !MODEL_FACTORY_QM_EDEFAULT.equals(modelFactoryQM);
		case GeneratorsPackage.EXCEL_GENERATOR__RESULT_SET:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case GeneratorsPackage.EXCEL_GENERATOR___EXCEL_GENERATOR__STRING_ARRAYLIST_ARRAYLIST_MODELFACTORY_INT_INT_STRING:
			ExcelGenerator((String) arguments.get(0), (ArrayList) arguments.get(1), (ArrayList) arguments.get(2),
					(ModelFactory) arguments.get(3), (Integer) arguments.get(4), (Integer) arguments.get(5),
					(String) arguments.get(6));
			return null;
		...
		case GeneratorsPackage.EXCEL_GENERATOR___EXECUTE__ARRAYLIST_HASHMAP_INT_INT_INT:
			execute((ArrayList) arguments.get(0), (HashMap) arguments.get(1), (Integer) arguments.get(2),
		...
		case GeneratorsPackage.EXCEL_GENERATOR___GET_MAP_OF_COLUMN_BY_COLUMN__ARRAYLIST_INT_INT:
			return getMapOfColumnByColumn((ArrayList) arguments.get(0), (Integer) arguments.get(1),
					(Integer) arguments.get(2));
		case GeneratorsPackage.EXCEL_GENERATOR___CREATE_LIST_BOX__ARRAYLIST_XSSFSHEET_INT_INT:
			createListBox((ArrayList) arguments.get(0), (XSSFSheet) arguments.get(1), (Integer) arguments.get(2),
		...
		case GeneratorsPackage.EXCEL_GENERATOR___THE_FORMULA__INT_INT_INT_INT_INTEGER_INT_INT:
			theFormula((Integer) arguments.get(0), (Integer) arguments.get(1), (Integer) arguments.get(2),
					(Integer) arguments.get(3), (Integer) arguments.get(4), (Integer) arguments.get(5),
					(Integer) arguments.get(6));
			return null;
		case GeneratorsPackage.EXCEL_GENERATOR___CREATE_DEPENDENCE__ARRAYLIST_HASHMAP_ARRAYLIST:
			return createDependence((ArrayList) arguments.get(0), (HashMap) arguments.get(1),
					(ArrayList) arguments.get(2));
