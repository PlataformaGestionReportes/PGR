...
/**
 * This is the item provider adapter for a {@link pgr.domain.Report} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReportItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Report_filePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Report_filePath_feature", "_UI_Report_type"),
				 DomainPackage.Literals.REPORT__FILE_PATH,
				 true,
				 false,
				 false,
	...
	protected void addFileNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Report_fileName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Report_fileName_feature", "_UI_Report_type"),
				 DomainPackage.Literals.REPORT__FILE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Report)object).getFileName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Report.class)) {
			case DomainPackage.REPORT__FILE_PATH:
			case DomainPackage.REPORT__FILE_NAME:
